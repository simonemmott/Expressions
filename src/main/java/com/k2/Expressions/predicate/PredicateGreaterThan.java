...
public class PredicateGreaterThan extends AbstractPredicate implements Predicate {
	...
	public <Y extends Comparable<? super Y>> PredicateGreaterThan(Expression<? extends Y> expr1, Expression<? extends Y> expr2) {
		this.expr1 = expr1;
		this.expr2 = expr2;
	}

	public <Y extends Comparable<? super Y>> PredicateGreaterThan(Expression<? extends Y> expr, Y comp) {
		this.expr1 = expr;
		this.comp = comp;
	}
