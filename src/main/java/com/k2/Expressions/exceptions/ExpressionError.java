package com.k2.Expressions.exceptions;
...
public class ExpressionError extends Error {
	...
	private static final long serialVersionUID = -2789350479649702068L;
	 ...
	 */
	public ExpressionError(String message, Object ... replacements) {
	 ...
	 * @param replacements The objects to convert to strings to replace instances of '{}' in the message
	 */
	public ExpressionError(String message, Throwable cause, Object ... replacements) {
	 ...
	 * @param replacements The objects to convert to strings to replace instances of '{}' in the message
	 */
	public ExpressionError(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace, Object ... replacements) {
